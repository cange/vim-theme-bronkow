...
fun! bronkow#theme#init(colors)
  call bronkow#formats#setup()
  if get(g:, 'bronkow_style_loaded', 0) == 0
    call bronkow#style#init(a:colors)
  endif
...
fun! s:mapping(colors)
  ...
  call h.hilight('IncSearch',    'shade2', 'green2')
  call h.hilight('Search',       'green2', 'shade1')
  ...
  call h.hilight('Title',        'none', 'none', 'bold')
  call h.hilight('Visual',       'none', 'shade1')
  call h.hilight('VisualNOS',    'none', 'shade1')
  ...
  call h.hilight('FoldColumn',   'orange1', 'blue1')
  call h.hilight('DiffAdd',      'green3')
  call h.hilight('DiffChange',   'blue2')
  call h.hilight('DiffDelete',   'red1')
  call h.hilight('DiffText',     'orange2')
  ...
  call h.hilight('PMenuSbar',    'none', 'shade1')
  call h.hilight('PMenuThumb',   'none', 'shade3')
  call h.hilight('TabLine',      'shade1', 'shade4')
  call h.hilight('TabLineFill',  'shade2', 'shade1')
  call h.hilight('TabLineSel',   'shade1', 'blue2')
  call h.hilight('CursorColumn', 'none', 'red1')
  call h.hilight('CursorLine',   'none', 'shade3', 'bold')
  call h.hilight('ColorColumn',  'none', 'shade3')
  call h.hilight('Cursor',       'none', 'grey1')
  "
  ...
  call h.hilight('Underlined',   'blue3', 'none', 'underline')
  ...
  call h.hilight('iCursor',      'none', 'cyan2')
