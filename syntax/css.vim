...
" original source /usr/share/vim/vim7x/syntax/css.vim
...
syn keyword cssTagName a abbr address area b base bdo blockquote body br button
syn keyword cssTagName caption cite col colgroup del div h1 h2 h3 h4 h5 h6 head
syn keyword cssTagName hr html img i iframe img ins kbd link map menu meta
syn keyword cssTagName noscript p param pre q s script small span style sub sup
syn keyword cssTagName title u
" phrase tags
syn keyword cssTagName em strong dfn code samp kdb var
" data listing
syn keyword cssTagName dl dd dt li ol table tbody thead tfoot td th tr ul
" Media Elements
syn keyword cssTagName audio video source embed track
" Form
syn keyword cssTagName datalist fieldset form input keygen label legend option
syn keyword cssTagName optgroup output select textarea
" Semantic/Structural Elements
syn keyword cssTagName article aside canvas bdi command details dialog summary
syn keyword cssTagName figure figcaption footer header mark meter nav progress
syn keyword cssTagName ruby rt rp section time wbr
